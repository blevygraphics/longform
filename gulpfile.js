...
// Project related.
var project                 = 'LongformTimber'; // Project Name.
...
// Translation related.
var text_domain             = 'LongformTimber'; // Your textdomain here.
var translationFile         = 'LongformTimber.pot'; // Name of the transalation file.
var translationDestination  = './languages'; // Where to save the translation files.
var packageName             = 'LongformTimber'; // Package name.
var bugReport               = 'https://www.tilliumdesign.co'; // Where can users report bugs.
var lastTranslator          = 'Blaine Levy <hello@tilliumdesign.co>'; // Last translator Email ID.
var team                    = 'Tillium Design Co <hello@tilliumdesign.co>'; // Team's Email ID.

// Style related.
var styleSRC                = 'wp-content/themes/longform-timber/assets/scss/base.scss'; // Path to main .scss file.
var styleDestination        = 'wp-content/themes/longform-timber/dist/css'; // Path to place the compiled CSS file.
...
// Images related.
var imagesSRC               = 'wp-content/themes/longform-timber/assets/img/**/*.{png,jpg,gif,svg}'; // Source folder of images which should be optimized.
var imagesDestination       = 'wp-content/themes/longform-timber/dist/img/'; // Destination folder of optimized images. Must be different from the imagesSRC folder.
